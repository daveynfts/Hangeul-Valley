...
function isUnit18World() {
  return isWorldLevel(currentLesson()) && currentLesson().worldId === '2b-unit-18';
}
...
function artLoadForWorldPack(id) {
  ...
  if (id === '2b-unit-11' || id === '2b-unit-12' || id === '2b-unit-13' || id === '2b-unit-14' || id === '2b-unit-15' || id === '2b-unit-16' || id === '2b-unit-17' || id === '2b-unit-18') {
    return [
      { key: 'study_desk_hd', file: 'furniture/oak_study_desk.png' },
      CASSETTE_REVIEWED_ART
    ];
...
].map(spec => ({ ...spec, file: spec.file + '?v=20260916-unit16-art-complete' }));
...
const ART_CACHE_KEY = 'art-topik-778-extra-847-42217a8799a8';
