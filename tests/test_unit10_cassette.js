...
assert(drawn.length === 80, 'exactly 80 of them are the original 어휘 headwords (found ' + drawn.length + ')');
assert(words.length - drawn.length === 38, '38 come from the later chapter pages');
